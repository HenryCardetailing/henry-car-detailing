    ...
    items: [
      ...
      },
      {
        ...
        },
        {
          ...
          desc: 'A careful engine bay cleanup that helps remove loose dirt, dust, and grime for a cleaner overall presentation under the hood.',
          includes: [
            'Light degreasing and wipe down',
            'Plastic and trim refreshed as needed',
            'Best added onto exterior or full detail services',
          ],
        },
        {
          name: 'Odor Treatment',
          price: '$25-$45',
          time: 'Add-on time varies',
          desc: 'Helps cut down lingering odors from smoke, food, pets, or everyday buildup when the interior needs more than a visual cleanup.',
          includes: [
            'Interior odor-focused treatment',
            'Best paired with interior cleaning services',
            'Quoted based on severity and source of odor',
          ],
        },
        {
          ...
          desc: 'A good add-on for leather seating and surfaces that need a cleaner, more finished look with conditioning afterward.',
          includes: [
            'Leather surfaces cleaned',
            'Conditioner applied after cleaning',
            'Helps improve feel and finished appearance',
          ],
        },
        {
